...
const Projects = () => {
  ...
  return <section id="projects" className="py-12 sm:py-16 md:py-20 lg:py-24 relative">
      <div className="container md:px-6 mx-px my-0 py-0 px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
          ...
          once: true
              ...
              <div className="p-4 sm:p-5 flex flex-col flex-grow py-0 px-0">
                <h3 className="text-lg sm:text-xl font-semibold mb-2">{project.title}</h3>
                <p className="text-muted-foreground text-sm mb-3 flex-grow">{project.description}</p>
                <div className="flex flex-wrap gap-1.5 mb-3">
                  {project.tags.map(tag => <span key={tag} className="text-xs px-2 py-0.5 bg-primary/10 rounded-full">
                      {tag}
                    </span>)}
                </div>
