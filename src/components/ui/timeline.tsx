...
export const Timeline = ({
  ...
  return <div className="w-full bg-transparent font-sans md:px-10" ref={containerRef}>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => <motion.div key={index} initial={{
        opacity: 0,
        x: -30
      }} animate={{
        opacity: 1,
        ...
        delay: index * 0.15
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full glass-card rounded-xl p-6 md:p-8 py-0 my-0 mx-0 px-[19px]">
